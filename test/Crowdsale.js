...
describe('Crowdsale', () => {
	...
	describe('Buying Tokens', () => {
		...
		describe('Failure', () => {
			it('rejects insuffient ETH', async () => {
				await expect(crowdsale.connect(user1).buyTokens(tokens(10), { value: 0})).to.be.reverted
			})

			// it('rejects insuffient supply', async () => {
			// 	await expect(ethers.provider.getBalance(crowdsale.address), { value: 1 }).to.be.reverted
			// })
		})
		...
		describe('Sending ETH', () => {
			...
			describe('Success', () => {
				...
				beforeEach(async () => {
				// this allows us to send direct from MM instead of a website using ethers.js...
